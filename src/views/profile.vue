        ...
        <div class="p-4">
            ...
            <b-card class="my-3 px-2">
             ...
             <b-row>
              ...
              <b-card class="my-3 p-2" v-for="(reff,index) in this.reffrences" v-bind:key="index" >
             <reffrence v-bind:reffrence="reff"  v-bind:type="'item'" ></reffrence>
            </b-card> 
            ...
            <b-card class="my-3 px-2">
             <b-row class="justify-content-between align-items-start">
                <h4 class="text-start card-title mb-4 p-1 font-weight-bold">Organization</h4>
                <b-button variant="link" class="font-weight-bold h5 text-dark" v-b-toggle.collapse-org > + Add Organization</b-button>
             </b-row>
             <b-row>
                <b-collapse id="collapse-org" class="mt-2" style="flex:1">
                    <organization v-bind:type="'newItem'" ></organization>
                </b-collapse>
             </b-row>
            </b-card>
            <b-card class="my-3 p-2"  v-for="org in this.organizations" v-bind:key="org._id" >
                <organization v-bind:organization="org"  v-bind:type="'item'"  ></organization>
            </b-card>
        </div>
...
export default {
    ...
    computed:{
        ...mapGetters(['experiances','educations','contacts','projects','reffrences','organizations','skills'])
    },
    methods:{
